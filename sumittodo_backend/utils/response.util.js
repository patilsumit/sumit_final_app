...
function MongooseErrorHandle(err, res) {
    ...
    if (err.name === 'CastError') {
        return response(400, { field: 'ObjectId', message: 'Must be a single String of 12 bytes or a string of 24 hex characters', reason: 'Must be a single String of 12 bytes or a string of 24 hex characters' }, res)
    }
}

module.exports = {response,handleError,MongooseErrorHandle};
